...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train GPT-2 XL-style LM on WikiText")
    ...
    parser.add_argument("--tokenizer_name", type=str, default="gpt2-xl", help="Tokenizer name")
...
def build_model(tokenizer: GPT2Tokenizer, device: torch.device) -> GPT2LMHeadModel:
    config = GPT2Config(
