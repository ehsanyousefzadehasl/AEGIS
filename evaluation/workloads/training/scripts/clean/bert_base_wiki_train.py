...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train BERT-base MLM on WikiText")
    ...
    parser.add_argument("--tokenizer_name", type=str, default="bert-base-cased", help="Tokenizer name")
    ...
    with timed_run() as total_timer:
        ...
        if args.print_faketensor_estimate:
            try:
                ...
                print(f"FakeTensor estimation failed for this BERT workload: {exc}")
